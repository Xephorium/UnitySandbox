...
public class FirstPersonController : MonoBehaviour {
    ...
    [SerializeField] private HeadBobConfig headBobConfig = null;
    ...
    protected virtual void GetComponents() {
        ...
        m_headBob = new HeadBob(headBobConfig, moveBackwardsSpeedPercent, moveSideSpeedPercent);
    }
    ...
    protected virtual IEnumerator CrouchRoutine() {
        ...
        m_headBob.CurrentStateHeight = moveInputState.isCrouching ? m_crouchCamHeight : m_initCamHeight;
    ...
    protected virtual void HandleHeadBob() {
        ...
        if(moveInputState.hasInput && m_isGrounded  && !m_hitWall) {
            if(!m_duringCrouchAnimation) { // we want to make our head bob only if we are moving and not during crouch routine
                m_headBob.ScrollHeadBob(moveInputState.isRunning && CanRun(), moveInputState.isCrouching, moveInputState.inputVector);
